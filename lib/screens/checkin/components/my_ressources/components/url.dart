                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Container(
                            child: Text(widget.url[index]["documents"]["file_type"] == "image/jpeg" ? "Image" : widget.url[index]["documents"]["file_type"] == "video/mp4" ? "Vidéo" : "Lien",style: TextStyle(color: Colors.white,fontSize: 14.5,fontFamily: "AppFontStyle"),),
                            decoration: BoxDecoration(
