...
class Step5Subs{
  ...
  Map<String, dynamic> toMap() => {
    if(step5streamService.current)...{
      ...
      "no_sport[confident_on_athletic_ability]": confident_on_athletic_ability.toString(),
      "no_sport[comfortable_place]": comfortable_place.toString(),
      "no_sport[place_to_practice]": place_to_practice.toString(),
      "no_sport[energy_to_practice]": energy_to_practice.toString(),
      "no_sport[time]": time.toString(),
      "no_sport[motivation]": motivation.toString(),
    },
    "id": id,
